...
> Working guide for Claude Code sessions on this project. Read this first, then [PROJECT_STATE.md](PROJECT_STATE.md) for current status before starting any task. If a decision here conflicts with something newer in [DECISIONS.md](DECISIONS.md), the more recent decision wins — update this file to match.
>
